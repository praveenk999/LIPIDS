...
class OLSNET(nn.Module):
    ...
    def __init__(self,nin_img,nout_img,fuse_type,use_BN,in_c,other):
        super(LSNET,self).__init__()

        self.ps_fcn = PS_FCN(fuse_type,use_BN,in_c,other)
    ...
    def forward(self,x,epoch):
        ...
        ans = self.ps_fcn((img_reshaped, light_reshaped))
        return ans
