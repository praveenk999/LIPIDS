...
class BaseOpts(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--out_img',      default=10)
        
        self.parser.add_argument('--save_result', default='data/results/')
        self.parser.add_argument('--error_map', default=False, action='store_true')
        self.parser.add_argument('--evaluate',default=True,  action = 'store_false')
